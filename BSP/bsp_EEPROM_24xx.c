...
/*
*********************************************************************************************************
*	函 数 名: BSP_EE_ReadBytes
*	功能说明: 从串行EEPROM指定地址处开始读取若干数据
*	形    参:  _usAddress : 起始地址
*			 _usSize : 数据长度，单位为字节
*			 _pReadBuf : 存放读到的数据的缓冲区指针
*	返 回 值: ERROR 表示失败，OK表示成功
*********************************************************************************************************
*/
uint32_t BSP_EE_ReadBytes(uint8_t DevAddr, uint8_t *_pReadBuf, uint16_t _usAddress, uint16_t _usSize)
{
	...
	i2c_SendByte(DevAddr | I2C_WR);	/* 此处是写指令 */
	...
	i2c_SendByte(DevAddr | I2C_RD);	/* 此处是读指令 */
